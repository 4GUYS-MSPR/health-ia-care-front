...
class MemberDeleteDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      title: Text(l10n.memberDeleteDialogTitle),
      content: Text(l10n.memberDeleteDialogContent),
      actions: [
        TextButton(
          onPressed: () => Navigator.of(context).pop(false),
          child: Text(l10n.memberDeleteDialogCancelButton),
        ),
        FilledButton(
          ...
          child: Text(l10n.memberDeleteDialogConfirmButton),
        ),
      ],
    );
  }
